...
int main(void)
{
  ...
  while (1)
  {
	...
	//  HAL_TIM_PWM_Start(&htim2, TIM_CHANNEL_3);
	  ...
	  // --- Turn left (Reduce/stop right motor) ---
	  __HAL_TIM_SET_COMPARE(&htim2, TIM_CHANNEL_3, 2000);  // Left motor keeps moving
	  __HAL_TIM_SET_COMPARE(&htim2, TIM_CHANNEL_2, 0000);   // Right motor slows down
	  HAL_Delay(2000);

	  // --- Turn right (Reduce/stop left motor) ---
	  __HAL_TIM_SET_COMPARE(&htim2, TIM_CHANNEL_3, 0000);   // Left motor slows down
	  __HAL_TIM_SET_COMPARE(&htim2, TIM_CHANNEL_2, 2000);  // Right motor full speed
	  HAL_Delay(2000);

	  // --- Stop both motors ---
	  __HAL_TIM_SET_COMPARE(&htim2, TIM_CHANNEL_3, 0);  // Left motor stop
	  __HAL_TIM_SET_COMPARE(&htim2, TIM_CHANNEL_2, 0);  // Right motor stop
